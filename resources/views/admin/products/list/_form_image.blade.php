<form role="form" method="post" action="{{ action('Admin\ProductsController@postCreateImage', ['id' => $product->id]) }}" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <p class="help-block">Выбирайте файл со своего компьютера и нажимайте кнопку "Сохранить изображение". Изображение будет трансформировано к размеру 973px * 615px.</p>
    </div>
    <div class="form-group">
