<?php namespace Emotions\Http\Controllers\Admin\Auth;

use Emotions\Http\Controllers\Admin\AdminController;
use Emotions\Services\AuthenticatesAndRegistersAdmins;
