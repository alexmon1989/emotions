...
class StoreArticlesRequest extends Request {
	...
	{
        // На некоторых страницах не нужно, чтоб поле Назнаие было обязательным
        if (Request::segment(2) == 'about' or Request::segment(2) == 'contacts' or Request::segment(2) == 'payments')
        {
            $this->rules['title'] = '';
        }
		return $this->rules;
